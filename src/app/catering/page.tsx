...
export default function CateringPage() {
  ...
  return (
    <>
      <Head>
        <title>קייטרינג לאירועים - שלג-רוז | תפריטים מיוחדים למסיבות ואירועים בבקעת אונו, רחובות, כפר הנוער, בן שמן ומצליח</title>
        <meta name="description" content="קייטרינג לאירועים, מסיבות ואירועים משפחתיים. תפריטים מיוחדים עם דגים, עופות ובשרים. הזמנה מינימלית 50 אנשים. משלוח עד הבית בבקעת אונו, רחובות, כפר הנוער, בן שמן ומצליח. כשר בהשגחת הרבנות." />
        <meta name="keywords" content="קייטרינג, אירועים, מסיבות, תפריטים לאירועים, קייטרינג כשר, אוכל לאירועים, הזמנת קייטרינג, בקעת אונו, רחובות, כפר הנוער, בן שמן, מצליח, דגים, עופות, בשרים, סלטים, תבשילים" />
        <meta property="og:title" content="קייטרינג לאירועים - שלג-רוז | תפריטים מיוחדים למסיבות ואירועים" />
        <meta property="og:description" content="קייטרינג לאירועים, מסיבות ואירועים משפחתיים. תפריטים מיוחדים עם דגים, עופות ובשרים. הזמנה מינימלית 50 אנשים. משלוח עד הבית בבקעת אונו, רחובות, כפר הנוער, בן שמן ומצליח." />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "areaServed": {
              "@type": "Place",
              "name": "בקעת אונו, רחובות, כפר הנוער, בן שמן ומצליח"
            },
