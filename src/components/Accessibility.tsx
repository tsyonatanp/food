  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed-button left-0 bottom-1/3 z-[9999] bg-blue-600 hover:bg-blue-700 text-white rounded-r-full pl-4 pr-6 py-4 shadow-lg transition-colors duration-200 bg-opacity-80 hover:bg-opacity-100"
